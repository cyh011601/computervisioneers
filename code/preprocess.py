...
class Datasets():
    ...
    def calc_mean_and_std(self):
        ...
        #
        #       Note: This is a mean image (the mean input data point).
        # ==========================================================

        self.mean = np.mean(data_sample, axis=0, dtype=np.float64)
        self.std = np.std(data_sample, axis=0, dtype=np.float64)
